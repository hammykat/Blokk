...
previous frame time to the current frame time, and if it surpasses
that or is equal to it, it'll destroy the previously created thread, 
as it didn't offer any performance difference.

  At the start of the program, the engine will only open up
